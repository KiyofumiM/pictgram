...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	private static final String[] URLS = { "/", "/css/**", "/images/**", "/scripts/**", "/h2-console/**",
			"/favicon.ico", "/OneSignalSDKWorker.js", "/error" };
	/**
	 * 認証から除外する
	 */
	@Override
	...
	public FormAuthenticationProvider getAuthenticationProvider() {
		return authenticationProvider;
	}

	public void setAuthenticationProvider(FormAuthenticationProvider authenticationProvider) {
